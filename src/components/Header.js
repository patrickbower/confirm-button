...
function Header() {
  return (
    <header className="h-14 bg-tarmac border-b border-ebony flex flex-row items-center px-3 mb-4">
      <div className="flex items-center">
        <svg className="fill-current text-chalk h-8" viewBox="0 0 240 240">
          <path
      ...
      <div className="flex items-center sm:pl-5">
        <p className="font-semibold text-16 uppercase px-4">
          <Link to="/">HOME</Link>
        </p>
        <p className="font-semibold text-16 uppercase px-4">SCHEDULE</p>
        <p className="font-semibold text-16 uppercase px-4">SPORTS</p>
      </div>
      <div className="flex items-center flex-grow justify-end">
        <p className="font-semibold text-14 uppercase px-5 py-1.5 border-2 border-chalk hidden md:flex">
          Refer a Friend
        </p>
        <button className="font-semibold text-16 uppercase px-4 pl-6 items-center hidden md:flex">
          MENU
          <svg
            viewBox="0 0 16 16"
            className="fill-current text-chalk h-4 pl-1.5"
          >
        ...
        <svg
          viewBox="0 0 240 240"
          className="fill-current text-chalk h-6 stroke-current stroke-8 pl-3"
        >
          <g fillRule="evenodd">
            <path d="M147.318 153.682l6.364-6.364 40.351 40.35-6.364 6.365z"></path>
            <path
              d="M160 107.5c0-28.995-23.505-52.5-52.5-52.5S55 78.505 55 107.5 78.505 160 107.5 160s52.5-23.505 52.5-52.5zm-114 0C46 73.534 73.534 46 107.5 46S169 73.534 169 107.5 141.466 169 107.5 169 46 141.466 46 107.5z"
              fillRule="nonzero"
            ></path>
          </g>
        </svg>
